...
export const MYSTIC_SKILLS_BASE = [
  "Ceremoni",
  "Förnimma",
  "Förvränga",
] as const
...
export const DYNAMIC_SKILL_TYPES: Record<
  DynamicSkillType,
...
export const SKILL_STATUS_INFO = {
  ...
  B: {
    name: "Blockerad",
    effect:
      "Kan ej höjas, Fokus får ej spenderas, -1 Välmående att använda (max 1/scen)",
    maxValue: 0,
  },
} as const

// Desensitization categories
export const DESENSITIZATION_CATEGORIES = [
  "Utsatthet",
  "Våld",
  "Övernaturligt",
] as const

export type DesensitizationCategory =
  (typeof DESENSITIZATION_CATEGORIES)[number]

export const DESENSITIZATION_BUYABLE_WITH: Record<
