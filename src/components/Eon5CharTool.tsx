...
export function Eon5CharTool() {
  ...
  const [state, dispatch] = useReducer(eon5Reducer, storedState || createInitialState())
      ...
      <Eon5DispatchContext.Provider value={dispatch}>
        <div className="p-8 space-y-6 max-w-4xl">
          ...
          <div className="space-y-6">
            <TogglableSection name="1. Attribut" isCollapsed={state.currentStep !== 0}>
              <Eon5AttributesSignals />
            </TogglableSection>
            ...
            <TogglableSection name="3. Färdigheter & Enheter" isCollapsed={state.currentStep !== 2}>
              <Eon5Skills />
            </TogglableSection>

            <TogglableSection name="4. Sammanfattning" isCollapsed={state.currentStep !== 3}>
              <Eon5Summary />
            </TogglableSection>
          </div>
        </div>
